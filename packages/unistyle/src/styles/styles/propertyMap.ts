...
const propertyMap: PropertyDescriptor[] = [
  ...
  // INSET
  {
    kind: 'edge',
    property: 'inset',
    keys: { full: 'inset', x: 'insetX', y: 'insetY', top: 'top', left: 'left', bottom: 'bottom', right: 'right' },
  },
  ...
  // SPACING
  {
    kind: 'edge',
    property: 'margin',
    keys: { full: 'margin', x: 'marginX', y: 'marginY', top: 'marginTop', left: 'marginLeft', bottom: 'marginBottom', right: 'marginRight' },
  },
  {
    kind: 'edge',
    property: 'padding',
    keys: { full: 'padding', x: 'paddingX', y: 'paddingY', top: 'paddingTop', left: 'paddingLeft', bottom: 'paddingBottom', right: 'paddingRight' },
  },
  ...
  // BORDERS
  {
    kind: 'border_radius',
    keys: {
      full: 'borderRadius', top: 'borderRadiusTop', bottom: 'borderRadiusBottom',
      left: 'borderRadiusLeft', right: 'borderRadiusRight',
      topLeft: 'borderRadiusTopLeft', topRight: 'borderRadiusTopRight',
      bottomLeft: 'borderRadiusBottomLeft', bottomRight: 'borderRadiusBottomRight',
    },
  },
  ...
  {
    kind: 'edge', property: 'border-width',
    keys: { full: 'borderWidth', x: 'borderWidthX', y: 'borderWidthY', top: 'borderWidthTop', left: 'borderWidthLeft', bottom: 'borderWidthBottom', right: 'borderWidthRight' },
  },
  {
    kind: 'edge', property: 'border-style',
    keys: { full: 'borderStyle', x: 'borderStyleX', y: 'borderStyleY', top: 'borderStyleTop', left: 'borderStyleLeft', bottom: 'borderStyleBottom', right: 'borderStyleRight' },
  },
  {
    kind: 'edge', property: 'border-color',
    keys: { full: 'borderColor', x: 'borderColorX', y: 'borderColorY', top: 'borderColorTop', left: 'borderColorLeft', bottom: 'borderColorBottom', right: 'borderColorRight' },
  },
